 ...
 *
 */
public class HomeImportExportDialog extends Dialog {

    private HomeActivity _configurationDialog;
     ...
     * @param context
     */
    public HomeImportExportDialog(HomeActivity context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File f = getExternalStorageDir(_configurationDialog, null);
...
//        String path = "/sdcard/" + f.getName();
        _textSaveUrl.setText(f.getPath());
        _textLoadUrl.setText(f.getPath());
        ...
        ((Button)findViewById(R.id.buttonImport)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    ...
                    dismiss();
                    _configurationDialog.refreshListView(false);
                }
                catch (IOException ioe)
                {
    ...
    {
        Log.i("HomeImportExportDialog", msg, t);
        Utils.showErrorMessage(this.getContext(), msg + ":" + t.getMessage());
    }

    public File getExternalStorageDir(HomeActivity context, String type) {
        File f = Environment.getExternalStorageDirectory();
        f = new File(f, Utils.getExportFilePath(context.getApplicationContext()));
        if (type != null)
            f=new File(f, type);
        f.mkdirs();
        return f;
